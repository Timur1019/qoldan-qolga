  ...
  return (
    <div className="page-container app-page">
      ...
      >
        ...
        <UiField label={t('auth.displayName')} htmlFor="displayName">
          <UiInput
            id="displayName"
            type="text"
            value={displayName}
        ...
        <UiField label={t('auth.email')} htmlFor="email">
          <UiInput
            id="email"
            type="email"
            value={email}
        ...
        {error ? (
          <UiAlert compact>{error}</UiAlert>
        ) : null}
        {success ? <UiAlert variant="success" compact>{t('common.save')} ✓</UiAlert> : null}

        <UiButton type="submit" fullWidth loading={saving} className={styles.saveBtn}>
